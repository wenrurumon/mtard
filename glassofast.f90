subroutine glassofast(n,S,L,thr,maxIt,msg,warm,X,W) bind(c, name='glassofast')
  use iso_c_binding

!     .. Scalar Arguments ..
  implicit double precision(a-h, o-z)
  integer(c_int), value :: n, maxIt, msg, warm
  real(c_double), value :: thr
!     ..
!     .. Array Arguments ..
  double precision S(n,n), L(n,n), X(n,n), W(n,n)
!     .. Internal ..
  double precision Wd(n), WXj(n)
!     ..
!
!  Purpose
!  =======
